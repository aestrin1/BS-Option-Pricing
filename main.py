...
def main():
    ...
    st.markdown("<h2 style='text-align: center;'>AE</h2>", unsafe_allow_html=True)

    st.markdown("<p style='text-align: center;'>This app calculates the price and greeks of a European call or put option using the Black-Scholes model and displays the results using an interactive plot.</p>", unsafe_allow_html=True)
